...
require('jenkins-js-modules').whoami('js-widgets:jenkins-js-widgets');
...
exports.configTabBar = function() {
    return require('./js/config/tabbar.js');
		...
		require('jenkins-js-modules').export('js-widgets', 'jenkins-js-widgets', module);
    });


},{"./js/config/tabbar.js":2,"jenkins-js-modules":4}],2:[function(require,module,exports){
...
},{"./table-metadata":3,"jenkins-js-modules":4}],3:[function(require,module,exports){
/*
...
},{"jenkins-js-modules":4}],4:[function(require,module,exports){
